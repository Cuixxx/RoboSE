...
def rollout(env, model, task_oracle, subtask, lang_annotation):#这是运行试验的主要代码
    """
    ...
    for step in pbar:
        ...
        lang_embeddings = model.encode_instruction(lang_annotation, model.args.device)#[1, 16, 512]，所以只要把这里换成一个[1, 1, 512]的embedding就好了
