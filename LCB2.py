...
class LISAForCausalLM(LlavaLlamaForCausalLM):
    ...
    def model_forward(self,
        ...
        **kwargs,
        ...
        # seg_token_mask = torch.cat([torch.zeros((seg_token_mask.shape[0], 255)).bool().cuda(), seg_token_mask], dim=1,) #[bs, 255+sequence_length] 255+82=337
        ...
        hidden_states.append(self.model.text_hidden_fcs[0](output_hidden_states[-1].float().detach()))
