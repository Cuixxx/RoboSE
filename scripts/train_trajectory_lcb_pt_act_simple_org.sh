...
run_log_dir=1113simpleactprompttuninglcbABC_D-gpu$ngpus-step1$train_iters-step2$stage2_train_iters-C$C-B$B-lr$lr-DI$dense_interpolation-$interpolation_length-H$num_history-DT$diffusion_timesteps-backbone$backbone-S$image_size-R$relative_action-wd$wd
