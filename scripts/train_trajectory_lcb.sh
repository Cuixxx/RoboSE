...
valset=/wangdonglin/calvin/packaged_ABC_D/validation
...
training_checkpoint=/storage/dingpengxiang/3d_diffuser_actor/train_logs/diffuser_actor_calvin_nohistory.pth
#当使用这个checkpoint时，起始train_iters就是65000，要在这个基础上加
# run_log_dir=10261547prompttuninglcbABC_D-gpu$ngpus-step1$train_iters-step2$stage2_train_iters-C$C-B$B-lr$lr-DI$dense_interpolation-$interpolation_length-H$num_history-DT$diffusion_timesteps-backbone$backbone-S$image_size-R$relative_action-wd$wd
run_log_dir=1121percent5prompttuninglcbABC_D-gpu$ngpus-step1$train_iters-step2$stage2_train_iters-C$C-B$B-lr$lr-DI$dense_interpolation-$interpolation_length-H$num_history-DT$diffusion_timesteps-backbone$backbone-S$image_size-R$relative_action-wd$wd
